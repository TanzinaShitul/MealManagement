  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <header id="myCarousel" class="carousel slide">
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('pic/A.jpg');"></div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('pic/B.jpg');"></div>
            </div>

            <div class="item">
                <div class="fill" style="background-image:url('pic/C.jpg');"></div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('pic/D.jpg');"></div>
            </div>
        </div>
    </header>
    ...
    <div class="cls1"> <!-- This div Containing Whole thing-->
        ...
        <footer class="text-center">
            ...
            <p><strong>Project: </strong> Tidy Meal Master</p>
            <p>Developed By Team: "Tanzina And Siti",    Department of CSE, LU.</p>
        </footer>
